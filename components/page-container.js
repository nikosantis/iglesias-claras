    ...
    <div>
      <Head>
        ...
        {description !== false && (
          <meta
            name='description'
            content={description || 'Base de datos de una gran cantidad de comunidades cristianas, enumerada por la claridad con la que comunican sus políticas que impactan a personas LGBTIQ+ y a mujeres en el liderazgo.'}
          />
        )}
      </Head>
